...
<title>Gecap-Evaluations-2024</title>
...
<div class="media d-flex">
<span class="avatar flex-shrink-0">
<img alt="" src="{{ URL::to('admin-template/assets/img/profiles/avatar-13.jpg') }}">
</span>
<div class="media-body flex-grow-1">
...
<li class="submenu">
<a href="/"><img src="{{ URL::to('admin-template/assets/img/icons/product.svg') }}" alt="img"><span> ADMINISTRATIVE</span> <span class="menu-arrow"></span></a>
<ul>
...
<li><a href="{{url('grilles/listes')}}"> GRILLE</a></li>
