@extends('layouts.interfaceevaluation')
@section('content')
<div class="page-header">
    ...
    <div class="page-btn">
    <a href="{{url('evaluations/ajout')}}" class="btn btn-added"><img src="{{ URL::to('admin-template/assets/img/icons/plus.svg') }}" alt="img" class="me-2">Ajouter Evaluation</a>
    </div>
    </div>
    <div class="card">
        <div class="card-body">
