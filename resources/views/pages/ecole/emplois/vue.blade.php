...
<div class="container mt-5">
    <strong>
        <h3 class="detail-info">Détail Emplois de l'ecole  {{ Auth::guard('ecole')->user()->nom }}</h3>
    </strong>
    ...
    <!-- Affichage de l'ecole en bas si le cycle n'est pas 1 -->
    ...
    <footer>
        <div class="footer-button">
            ...
            <a class="btn btn-primary" target="_blank" href="{{url ('/pages/ecole/emplois/pdf/'.$DetailEmploi->id)}}">Télécharger</a>
        </div>
    </footer>
</div>
