                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-img"><img
                                src="{{ URL::to('admin-template/assets/img/profiles/hamid.jpg') }}" alt="">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            <div class="profileset">
                                <span class="user-img"><img
                                        src="{{ URL::to('admin-template/assets/img/profiles/hamid.jpg') }}"
                                        alt="">
                                    <span class="status online"></span></span>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                                    ...
                                    alt="img"><span> Administrative</span> <span class="menu-arrow"></span></a>
                            <ul>
...
<li><a href="createsalesreturns.html">New Sales Return</a></li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                                    src="{{ URL::to('admin-template/assets/img/icons/purchase1.svg') }}"
                                    alt="img"><span> Pedagogie</span> <span class="menu-arrow"></span></a>
                            <ul>
...
<li><a href="importpurchase.html">Import Purchase</a></li> --}}
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"><img
                                    src="{{ URL::to('admin-template/assets/img/icons/expense1.svg') }}"
                                    alt="img"><span> Ressources</span> <span class="menu-arrow"></span></a>
                            <ul>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget">
                            <div class="dash-widgetimg">
                                <span><img src="{{ URL::to('admin-template/assets/img/icons/dash1.svg') }}"
                                        alt="img"></span>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash1">
                            <div class="dash-widgetimg">
                                <span><img src="{{ URL::to('admin-template/assets/img/icons/dash2.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="dash-widgetcontent">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash2">
                            <div class="dash-widgetimg">
                                <span><img src="{{ URL::to('admin-template/assets/img/icons/dash3.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="dash-widgetcontent">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="dash-widget dash3">
                            <div class="dash-widgetimg">
                                <span><img src="{{ URL::to('admin-template/assets/img/icons/dash4.svg') }}"
                                        alt="img"></span>
                            </div>
                            <div class="dash-widgetcontent">
                                ...
                                <div class="graph-sets">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                            ...
                                            2022 <img
                                                src="{{ URL::to('admin-template/assets/img/icons/dropdown.svg') }}"
                                                alt="img" class="ms-2">
                                        </button>
                                    ...
                                    <table class="table datatable ">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    <a href="productlist.html" class="product-img">
                                                        <img src="{{ URL::to('admin-template/assets/img/product/product22.jpg') }}"
                                                            alt="product">
                                                    </a>
                                            ...
                                            <tr>
                                                ...
                                                <td class="productimgname">
                                                    <a href="productlist.html" class="product-img">
                                                        <img src="{{ URL::to('admin-template/assets/img/product/product23.jpg') }}"
                                                            alt="product">
                                                    </a>
